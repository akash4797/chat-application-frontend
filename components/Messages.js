    ...
    <>
      {selectedUser ? (
        <div className="h-full relative flex flex-col">
          <div className="py-3 bg-gray-200 px-5 flex gap-2 items-center md:rounded-tl-none rounded-tl-xl rounded-tr-xl">
            <div className="w-10">
              <UserImageOrWithout
                // @ts-ignore
          ...
          <div className="h-20 absolute bottom-0 w-full bg-gray-200 rounded-bl-xl md:rounded-bl-none rounded-br-xl">
            <form
